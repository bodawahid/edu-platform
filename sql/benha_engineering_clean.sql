...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2026 at 03:10 PM
...
(3, 1, 5, 'sorting_assignment_test.zip', 'uploads/submissions/1/student_5_sorting.zip', 1792000, 'application/zip', NULL, '2026-06-16 08:00:00', 0, 78.00, 'Well structured code but missing complexity analysis in the report.', 3, '2026-06-17 10:00:00', 'graded');
...
(1, 'CSE101', 'Introduction to Computer Science', 'Fundamentals of computer science including algorithms, data structures, programming basics, and problem-solving techniques using C language.', 'Computer Engineering', 'First', 1, 3, 1, 2, '2026-06-14 08:20:00', '2026-06-14 08:20:00'),
...
(5, 1, 5, '2026-06-14 09:00:00', 'active'),
(6, 2, 5, '2026-06-14 09:01:00', 'active'),
(7, 3, 5, '2026-06-14 09:02:00', 'active');
...
(5, 2, 'doctor', 'assignment_submission', '📤 Assignment Submitted', 'Student (Mostafa Sayed) submitted a solution for "Programming Assignment #1".', 0, '2026-06-15 10:30:00'),
(6, 2, 'doctor', 'assignment_submission', '📤 Assignment Submitted', 'Student (test admin) submitted a solution for "Programming Assignment #1".', 0, '2026-06-16 08:00:00'),
...
(6, 2, 1, 'Central Processing Unit', 1, 2.00, '2026-06-15 10:00:00'),
(7, 2, 2, 'HTML', 0, 0.00, '2026-06-15 10:01:00'),
(8, 2, 3, 'True', 1, 2.00, '2026-06-15 10:02:00'),
(9, 2, 4, 'O(n)', 0, 0.00, '2026-06-15 10:03:00'),
(10, 2, 5, 'False', 0, 0.00, '2026-06-15 10:04:00');
...
(2, 1, 5, '2026-06-15 09:55:00', '2026-06-15 10:05:00', 4.00, 10.00, 40.00, 'graded', 1200, '::1'),
...
(1, 'admin', 'admin@benha.edu.eg', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'System Administrator', 1, NULL, '+20-100-000-0001', 'IT Department', 1, '2026-06-14 08:00:00', '2026-06-14 07:00:00', '2026-06-14 08:00:00'),
(2, 'doctor', 'doctor@benha.edu.eg', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Dr. Ahmed Hassan', 2, NULL, '+20-100-000-0002', 'Computer Engineering', 1, '2026-06-14 08:05:00', '2026-06-14 07:00:00', '2026-06-14 08:05:00'),
...
(4, 'student', 'student@benha.edu.eg', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Mostafa Sayed', 4, NULL, '+20-100-000-0004', 'Computer Engineering', 1, '2026-06-14 08:15:00', '2026-06-14 07:00:00', '2026-06-14 08:15:00'),
(5, 'test', 'test@benha.edu.eg', '$2y$10$L395v7kwB9OJep9DgUSTf.Vfolx5wo9Bcajziot0sZbWHyiuTX2yG', 'Test Admin Account', 1, NULL, '+20-100-000-0005', 'IT Department', 1, '2026-06-14 09:00:00', '2026-06-14 07:00:00', '2026-06-14 09:00:00');
